...
bsc_fcn(x::Real) = x^2 + 1
bsc_fcn(2)
println("bsc_func(2) = ", bsc_fcn(2))
@time bsc_fcn(2)

bsc_fcn.([1.0,2.0])
println("bsc_func(2) = ", bsc_fcn.([1.0,2.0]))
...
println("bsc_func_typ(2) = ", bsc_func_typ(2.0))

@time bsc_func_typ(2.0)

@time bsc_func_typ.([1.0,2.0])
println("bsc_func_typ(2) = ", bsc_func_typ.([1.0,2.0]))

# Compare and print to REPL
err = abs(bsc_func_typ(2.0) - bsc_fcn(2))
println("abs(bsc_func_typ(2.0) - bsc_fcn(2)) = ", err)
...
@time bsc_func_notyp(2.0)
@time bsc_func_notyp.([1.0,2.0])
...
inpt_func = NwtFunc(test_func,CD)
nwtn_1D_a(1.1,1e-8,inpt_func) #x_0 = 1.0 converges, 1.1 diverges
